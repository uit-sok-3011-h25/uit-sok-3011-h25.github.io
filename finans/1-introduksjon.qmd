...
4. Bruk forskjellige VaR-modell på de historiske datane, kjør en tilbaketest på den (backtesting) og gi din vurdering av modellene.
...
7. Faktorene ligger "utfor" (til venstre) for porteføljefronten i forelesningsnotat 4 og antakeligvis i din besvarelse. Hvorder er dette uventet, og hva kan være årsaken?
